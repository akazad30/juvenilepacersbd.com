...
<html lang="en-US">
  ...
  <body class="size-1140">
   ...
   <header role="banner" class="position-absolute" style="background-color:#94B3CE">    
      <!-- Top Navigation -->
      <nav class="background-transparent background-transparent-hightlight full-width sticky" style="background-color:#94B3CE">
        <div class="s-12 l-2" style="background-color:#94B3CE">
          <a href="index.php" class="logo">
            <!-- Logo White Version -->
            <img class="logo-white" src="img/jp_logo.png" alt="">
            <!-- Logo Dark Version -->
            <img class="logo-dark" src="img/jp_logo.png" alt="">
          </a>
        </div>
        <div class="top-nav s-12 l-10">
          ...
          <ul class="right chevron">
            ...
            <li><a>Services</a>
              <ul>
                <li><a href="domain_hosting.php">Domain Hosting</a>
                  <ul>
                    <li><a href="linux_hosting.php">Linux Hosting</a></li>
                    <li><a href="#">Corporate Shared Hosting</a></li>
					<li><a href="#">Virtual Private Server(PVS)</a></li>
					<li><a href="#">Dedicated Server</a></li>
                  </ul>
                </li>
                <li><a href="corporate_soft.php">Corporate Software</a></li>
              ...
              <div class="s-12 m-12 l-4 margin-m-bottom">
                <div class="padding-2x block-bordered border-radius">
                  ...
                  <div class="margin-left-70 margin-s-left-0">
                    ...
                    <p><span class="text-primary">Infoline: 22222222</span><br>
                       Office: 2222222222222<br>
                       Office 2:22222222222
                    </p>             
                  </div>
                </div>
              </div>
    ...
    <!-- FOOTER -->
     <footer>
      <!-- Contact Us -->
      <div class="background-gray padding text-center">
      ...
      <section class="background-dark full-width">
        ...
        <div class="s-12 m-12 l-6 margin-m-bottom-2x">
          <div class="s-12 grayscale center">  	  
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7297.045441976057!2d90.38227011698534!3d23.871076162124613!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c416b37e3ccd%3A0xd9bdb666e2118cce!2sRd+No+20%2C+Dhaka+1230!5e0!3m2!1sen!2sbd!4v1472878401710" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
          </div>
        </div>
            ...
            <div class="line">              
              <div class="float-left">
                ...
                <div class="margin-left-70 margin-bottom-30">
                  <h3 class="margin-bottom-0">Company Address</h3>
                  <p>Uttara Housebuilding,Dhaka<br>
                  </p>               
                </div>
                <div class="float-left">
                ...
                <div class="margin-left-70">
                  <h3 class="margin-bottom-0">Phone Numbers</h3>
                  <p>0800 222 802220 5022<br>
                     2222 22 6222225 1226<br>
                     072298 652246 465 15
                  </p>             
                </div>
            </div>
          </div>
      ...
      <section class="padding background-dark full-width">
        <div class="s-12 l-6">
          <p class="text-size-12">&copy;Copyright juvenilepacersBD</p>
       
        </div>
        <div class="s-12 l-6">
          <a class="right text-size-12" href="#" title="Responsee - lightweight responsive framework">Design and coding<br> by juvenilepacers Team</a>
        </div>
      </section>
    </footer>
